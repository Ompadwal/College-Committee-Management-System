...
<title>College Committee Management</title>
<style>
body {
...
.main-container {
    display: flex;
    min-height: calc(100vh - 320px); /* Adjust based on header/footer height */
}
...
<nav class="navbar">
<ul>
<li><a href="committees/mainpage.php">Home</a></li>
    ...
    <!-- Sidebar with Committees -->
     <div class="sidebar">
        ...
        <ul id="committeeList">
            ...
            <!-- Document Viewer Modal -->
             <div class="document-modal" id="documentViewer">
                <div class="document-content">
                    <span class="close-document" onclick="closeDocumentViewer()">&times;</span>
        ...
        .then(data => {
            ...
            if (data.length === 0) {
                ...
                data.forEach(doc => {
                    ...
                    const isViewable = fileExt === 'pdf' || fileExt === 'jpg' || fileExt === 'jpeg' || 
                                      fileExt === 'png' || fileExt === 'gif' || fileExt === 'svg';
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <button class="view-button" onclick="viewDocument('${doc.file_path}', '${fileExt}')">View</button>
                        </td>
                    </tr>
                    `;
                });
