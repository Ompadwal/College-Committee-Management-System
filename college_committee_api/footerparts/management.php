...
<div class="top-banner1">
    ...
    <div class="heading">About Management</div>

    <div class="container">
        <div class="image-container">
            <img src="lokmanya-tilak.jpg" alt="Lokmanya Tilak">
        </div>

        <h2>INTRODUCTION</h2>
        <p>
            The father figure of Lokmanya Tilak is revered and the ideals that he stood for have inspired the founders of Parle Tilak Vidyalaya Association. Enlightenment, Social Progress, Patriotism, and Self-Esteem through education, the virtues that Tilak’s life taught us and his stress on education as a means to make us fit for service and sacrifice for our motherland became the goals for these founders. 
            With the changing times and the needs of society, the shift of emphasis on the type of education has taken place but the original goals have been the guiding lights. Over 20,000 students from pre-primary to postgraduate classes benefit from the educational institutes which are well-equipped with modern educational facilities and known for their high quality of education coupled with a cultural ethos that combines the traditional and the modern facets.
        </p>

        <div class="list-section">
            <h3>List Of Institutes Run By Parle Tilak Vidyalaya's Association</h3>

            <h3>Marathi Medium Schools</h3>
            <ul>
                <li>Parle Tilak Vidyalaya Primary School M.G.Road, Vile Parle (E), Mumbai -400057.</li>
                <li>Parle Tilak Vidyalaya Secondary School Hanuman Road, Andheri, Mumbai-400069.</li>
                <li>Paranjape Vidyalaya Primary School Sahar Road, Andheri, Mumbai – 400069.</li>
                <li>Paranjape Vidyalaya Secondary School Sahar Road, Andheri, Mumbai – 400069.</li>
            </ul>

            <h3>English Medium Schools</h3>
            <ul>
                <li>Parle Tilak Vidyalaya Primary School No. 2</li>
                <li>Parle Tilak Vidyalaya Secondary School No. 2</li>
                <li>ICSE School Thanawala Lane – Vile Parle (E), Mumbai – 400057.</li>
            </ul>

            <h3>Colleges</h3>
            <ul>
                <li>Sathaye College (Degree College) Dixit Road, Vile Parle (E), Mumbai- 400057.</li>
                <li>Sathaye College (Junior College) Dixit Road, Vile Parle (E), Mumbai- 400057.</li>
                <li>M. L. Dahanukar College of Commerce (Degree College) Dixit Road, Vile Parle (E), Mumbai- 400057.</li>
                <li>M. L. Dahanukar College of Commerce (Junior College) Dixit Road, Vile Parle (E), Mumbai- 400057.</li>
                <li>Mulund College of Commerce (Degree College) Dr. Sarojini Naidu Road, Mulund (W), Mumbai-400 080.</li>
                <li>Mulund College of Commerce (Junior College) Dr. Sarojini Naidu Road, Mulund (W), Mumbai-400 080.</li>
                <li>Institute of Management Studies Chitrakar Ketkar Marg, Vile Parle (E), Mumbai-400057.</li>
                <li>Mulund Centre for Commercial Education Dr. Sarojini Naidu Road, Mulund (W), Mumbai-400 080.</li>
            </ul>
        </div>
    </div>
