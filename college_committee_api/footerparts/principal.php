...
<head>
    ...
    <title>From The Principal's Desk</title>
    <style>
        /* Apply Mulund College of Commerce theme colors */
        :root {
...
<div class="top-banner1">
    ...
    <div class="heading">From The Principal's Desk</div>
    ...
    <div class="container">
        ...
        <div class="principal-name">Principal Dr. Sonali Pednekar</div>
