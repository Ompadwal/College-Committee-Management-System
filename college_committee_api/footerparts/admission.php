...
<head>
    ...
    <title>Admission Guidelines</title>
    <style>
...
<div class="top-banner1">
    ...
    <div class="heading">Admission Guidelines</div>

    <div class="container">
        <p>
            Admission is purely on merit and is subject to availability of seats as per the directions issued by the University of Mumbai and Directorate of Higher Education, Mumbai region from time to time, duly following the reservation policy of the Government of Maharashtra. A transparent admission procedure is followed strictly based on the standard norms. Any modification in admission guidelines will be notified on the college notice board at the time of admission.
        </p>
        ...
        <p>
            The college also provides for lateral entry and horizontal mobility to students i.e. students pursuing one particular programme can shift to another programme at the second year entry point as per University provision. For example, a student can shift between the courses of B.M.S. to B.Com. (Acct. and Finance) to B.Com.(Bank. and Insurance) or to B.Com.(Financial Markets) at second year level. A candidate who has passed 3 year recognised diploma (Diploma in Computer Engineering/ Computer Science/ Computer Technology) after 10th Standard is eligible for admission to second year B.Sc. IT (as per lateral entry provision of University of Mumbai) provided seats are available in the college.
        </p>

        <p>
            Further, students from other colleges can seek at the start of every academic year/ semester for a transfer to our college for the same programme provided it is within the stipulated time subject to the availability of seats and to the requisites and procedures laid down by the University of Mumbai.
        </p>

        <p class="highlight">
            Application to each course and to each category has to be submitted in separate admission form.
        </p>
    </div>
