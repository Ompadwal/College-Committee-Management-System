...
<head>
    ...
    <title>Programmes Offered | Mulund College Of Commerce</title>
    <style>
        body {
            margin: 0;
...
<div class="top-banner1">
    ...
    <main>
        <section class="container">
            <h2>Ph.D.</h2>
            <p>Ph.D. in Business Economics</p></br>


            <h2>Post-graduate Programmes:</h2>
            <h3>Commerce</h3>
            <ul>
                <li>M.Com (Advanced Accountancy) – Aided</li>
                <li>M.Com (Business Management)</li>
                <li>M.Com (Banking and Finance)</li>
                <li>M.Sc. (Finance)</li>
            </ul>
            ...
            <h3>Self-Finance:</h3>
            <ul>
                <li>BAF - B.Com (Accounting & Finance)</li>
                <li>BBI - B.Com (Banking and Insurance)</li>
                <li>BFM - B.Com (Financial Markets)</li>
                <li>BFSI - B.Com (Banking, Financial Services and Insurance) - Apprenticeship Embedded Degree Programme</li>
            </ul>

            <h3>School of Business</h3>
            <ul>
                <li>B.Com (Management Studies) - Bachelor of Commerce (Management Studies)</li>
                <li>B.Com (Business Administration) - Bachelor of Commerce (Business Administration)</li>
            </ul>

            <h3>Interdisciplinary</h3>
            <ul>
                <li>BAMMC – Bachelor of Arts (Multimedia and Mass Communication)</li>
            </ul>

            <h3>Science: School of Computing and Technology Self-Finance:</h3>
            <ul>
                <li>B.Sc. (Computer Science)</li>
                <li>B.Sc. (Information Technology)</li>
                <li>B.Sc. (Data Science)</li>
                <li>B.Sc. (Computer Applications)</li>
            </ul>
        </section>
    </main>
