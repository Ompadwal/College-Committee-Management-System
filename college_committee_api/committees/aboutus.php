...
<body>
    ...
    <!-- <heading>
        About Us - College Committee
    </heading> -->
    <div class="container">

    <h1>About Us</h1><br>
        
        <h2>Welcome to the College Committee Management System</h2>
        <p>Committees play a crucial role in college activities. Our system ensures efficiency, transparency, and smooth operations.</p>
        
        <h2>Our Vision</h2>
        <p>To create a digital ecosystem where committees operate efficiently, reducing paperwork and improving communication.</p>

        <h2>Our Mission</h2>
        <ul>
            <li>Simplify committee management with digital tools.</li>
            <li>Enhance transparency and security.</li>
            <li>Improve collaboration among committee members.</li>
            <li>Ensure accessibility for students and faculty.</li>
        </ul>
        ...
        <div class="features">
            <div class="feature-box">
                ...
                <p>Manage committees efficiently, assign roles, and track progress seamlessly.</p>
            </div>
            <div class="feature-box">
                <h3>Secure Access Control</h3>
                <p>Only authorized users can access the system, ensuring data security.</p>
            </div>
            <div class="feature-box">
                <h3>Document Storage</h3>
                <p>Upload, store, and manage committee documents securely.</p>
            </div>
            <div class="feature-box">
                <h3>Real-Time Updates</h3>
                <p>Get instant updates on committee changes, meetings, and events.</p>
            </div>
        </div>

        <h2>Who Can Use This Platform?</h2>
        <ul>
            <li>Committee Members – Manage data and documents.</li>
            <li>College Administration – Oversee committee operations.</li>
            <li>Students & Faculty – Access committee details and updates.</li>
        </ul>

        <h2>Why This System is Important?</h2>
        <p>Eliminates manual work, prevents data loss, and ensures efficient committee operations.</p>

        <h2>Join Us in This Digital Transformation!</h2>
        <p>Be a part of a structured, secure, and modern committee system.</p>
